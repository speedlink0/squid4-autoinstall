...
#installation ###already finish installation server,webserver start the installation with git clone
...
git clone https://github.com/speedlin0/squid4-autoinstall.git
